...
Scenario: Validate Empty Logged In Customer Authentication (negative scenario)
...
Scenario: Emailid validation for Logged In Customer Authentication (Negative scenario)    
...
Scenario: Password validation for Logged In Customer Authentication (Negative scenario)    
...
Scenario: Logged In Customer Order placed (postive scenario)

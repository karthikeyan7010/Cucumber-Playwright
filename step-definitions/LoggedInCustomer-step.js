...
Given('the user in Homepage and clicks Sigin button in header',{timeout: 2 * 5000}, async function () {
...
When(
    /^the user enters Invalid password in the required fields"([^"]*)","([^"]*)"$/,{timeout: 2 * 5000},

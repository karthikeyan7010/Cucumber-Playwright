...
defineStep('the user should be navigated to customer account page', async function () {
...
When('the user click on the create an account button', async function () {
    await loginPage.formsubmit()
})

Then('the user can be created a new account and redirected to My Account landing page', async function () {
